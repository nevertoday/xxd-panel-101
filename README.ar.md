<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 101" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 101｜دفتر ذكريات من تسع خانات

### يحوّل صورة واحدة إلى تسع لحظات يومية تستحق الاحتفاظ بها
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 101 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يناسب **Panel 101** الصور التي تستحق أجواؤها وأغراضها وتفاصيلها الصغيرة أكثر من إعادة رسم واقعية. ينظم المشهد نفسه في تسع وحدات ذاكرة مترابطة ضمن شبكة مرنة، ويستخدم الخربشات الساذجة وحبيبات الشمع والأقلام الملوّنة ليصنع صفحة يوميات بصرية شخصية.

### مناسب لـ

- تنظيم الصورة الغنية بالتفاصيل في تسعة موضوعات وأفعال وأغراض وإشارات عاطفية مترابطة؛
- منح الصورة الحرفية إحساساً شخصياً محفوظاً باليد عبر خطوط مرتجفة وحبيبات أدوات جافة؛
- الموازنة بين النظام والراحة بشبكة 3×3 ضمنية تتغير فيها أحجام الأيقونات وزواياها ومواضعها قليلاً؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات؛

### بداية سريعة

> استخدم XXD Panel 101 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** أيقونات ذاكرة 3×3 · خربشات ساذجة · شبكة مرنة · حبيبات الشمع والقلم الملوّن · ألوان حلوى قديمة · تعليقات يدوية
...
|---|---|
| **الناتج** | ملصق تحريري يشبه دفتر يوميات خاصاً، يربط الصورة الواقعية بقائمة ذكريات من تسع خانات |
| **البصمة الواضحة** | أيقونات 3×3 مرنة، خطوط يدوية ساذجة، حبيبات شمع وقلم ملوّن، ورق عاجي دافئ، وملاحظات حمراء قليلة |
| **احترام المصدر** | تأتي كل وحدة من موضوع أو تفصيل أو حركة أو غرض أو علاقة يمكن تمييزها في الصورة الحالية، من دون استبدال قصتها |
| **الاستخدامات** | يوميات السفر وذكريات العائلة ودفاتر الحيوانات الأليفة وملخصات الفعاليات والمحتوى الاجتماعي وخلفيات الأجهزة |
<!-- xxd-panel-benefit:end -->

## منطق التحويل

```text
قراءة الموضوع وإشارات الحياة اليومية → اختيار تسع ذكريات جديرة بالحفظ → ترتيب شبكة 3×3 ضمنية ومرنة → الترجمة بخطوط ساذجة وشمع/أقلام ملوّنة → اشتقاق ألوان حلوى قديمة من الأصل → إضافة كتابة قليلة وتعليقات حمراء
```

## سمات النتيجة النهائية

- تحمل الأيقونات التسع موضوع الصورة وسماته وأغراضه وأفعاله ومشاعره أو مشاهده الصغيرة كقائمة ذاكرة واحدة.
- يبقى نظام الشبكة محسوساً، لكن الحجم والزاوية والموضع تنزاح قليلاً فلا تبدو كجدول واجهة مستخدم.
- الخطوط مرتجفة ومتفاوتة السماكة وقد تبقى مفتوحة، ويكشف تلوين الشمع والقلم نسيج الورق والحواف الخشنة.
- يحمل الورق العاجي الدافئ أزرق مخضراً وأصفر ووردياً منخفض التشبع ولمسة ضئيلة من البرتقالي الأحمر، مع دوائر أو سهام أو نجوم حمراء قليلة.
- يبدو النص عنواناً يدوياً صغيراً أو caption؛ وتُتجنب الواقعية والمتجهات المصقولة والظلال الثقيلة والقوالب التجارية ورسوم الأطفال.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-101-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 101. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-101 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-101 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-101 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-101 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-101 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 101 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-101 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-101`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-101-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-101-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ101 على موجّهه الأصلي ومنطقه الجمالي المستقل. يعرض الجدول روابط جميع المشاريع وخصائص أسلوبها الأساسية، مع تمييز المشروع الحالي بخط عريض.
...
| **[xxd-panel-101](https://github.com/nevertoday/xxd-panel-101)** | دفتر ذكريات من تسع خانات · أيقونات 3×3 · خربشات ساذجة · حبيبات شمع وقلم · ألوان قديمة · ملاحظات حمراء |
...
### القيادة العامة لـ Xiaoxiaodong · Skill القائد العام · 101 يوان صيني

تمنحك دفعة واحدة قدرها 101 يوان صيني Skill القائد العام لهذه السلسلة (`xxd-panel-all`) لإدارة جميع Skills الجنود والتوصية بها واستدعائها وتنسيق العمل الدفعي. اكتب «Skill القائد العام» في رسالة WeChat.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–101) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
