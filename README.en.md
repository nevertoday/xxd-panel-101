...
Each of the 101 Panels preserves its own original brief and aesthetic logic. The table continuously lists every project from 001 through 101 with its defining style characteristics; the current project is bold.
...
| **Soldiers** | `xxd-panel-NNN` (currently 001–101) | Each numbered Skill executes only its own original brief and aesthetic, completing the individual job assigned by the General. |
